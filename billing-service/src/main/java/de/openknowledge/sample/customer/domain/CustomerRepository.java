/*
 * Copyright 2019 - 2022 open knowledge GmbH
 *
...
public class CustomerRepository {
    ...
    public void initialize() {
        ...
        customers.put(new CustomerNumber("0815"),
            new Customer(new CustomerNumber("0815"), new UserName("max")));
        customers.put(new CustomerNumber("0816"),
            new Customer(new CustomerNumber("0816"), new UserName("erika")));
        customers.put(new CustomerNumber("007"),
            new Customer(new CustomerNumber("007"), new UserName("james")));
